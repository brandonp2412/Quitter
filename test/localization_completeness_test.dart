...
void main() {
  ...
  test('Russian translations avoid known machine-translation artifacts', () {
    ...
    const forbiddenGlobally = {
      ...
      'оставайся сильным',
      'без уничтожения новых b12',
      'процесс ремонта',
      'значительно большую энергию',
      'к этому моменту сразу же',
      'беспокойство, беспокойство',
      'контролируемое сужение',
      'головные боли, боли',
      'пьющие, пьющие больше',
      'сиозс, сиозс и тца',
      'обратный химический захват мозга',
      'клиническое вымывание',
      'примерно в середине примерно',
      'медицинское руководство',
      'гормональная система мозг-яички',
      'уровень гормонов, отвечающих за выработку тестостерона и самого тестостерона',
      'часто выздоравливают',
      'выход из аддералла',
      'остановка является важным первым шагом',
      'проходят абстиненцию',
