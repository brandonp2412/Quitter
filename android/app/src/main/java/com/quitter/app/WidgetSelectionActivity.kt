...
class WidgetSelectionActivity : Activity() {
    ...
    private fun setupRecyclerView() {
        ...
        val knownAddictions = mapOf(
            ...
            "smokeless_tobacco" to Triple(getString(R.string.addiction_smokeless_tobacco), R.drawable.ic_widget_grass, 0xFF92400E.toInt()),
            ...
            "heroin" to Triple(getString(R.string.addiction_heroin), R.drawable.ic_widget_medication, 0xFFB91C1C.toInt()),
            "fentanyl" to Triple(getString(R.string.addiction_fentanyl), R.drawable.ic_widget_medication, 0xFFDC2626.toInt()),
