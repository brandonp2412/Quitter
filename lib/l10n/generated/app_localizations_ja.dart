...
class AppLocalizationsJa extends AppLocalizations {
  ...
  String get ghbReferenceDay3 =>
      'GHBの引き出し：最も困難な日々\n\n出典：\"Characterization of the GHB Withdrawal Syndrome,\" on PubMed Central\n\n最もラフなストレッチ\nこの研究では、筋肉痛、筋肉のけいれん、緊張感、ストレス感、速い心拍数、腹部けいれんなどのいくつかの中核的な離脱症状が最初の3日間で最悪であり、4日目までに多くの症状の重症度が70 ％以上低下したことがわかりました。 この早期ウィンドウは、一般的に最もリスクの高い期間であり、未治療の離脱は、せん妄、発作、または心拍数と血圧の危険な変動に向かってエスカレートする可能性が最も高い。\n\n重度の特徴\n• 激しい動揺と不安\n• 幻聴と幻視\n• 震え、発汗、心拍、高血圧\n• 発作のリスク\n\n経営陣\nこの研究では、ベンゾジアゼピンのテーパリングと医薬品のGHBのテーパリングが一般的に使用されている2つの解毒方法として説明されており、GHBのテーパリングがベンゾジアゼピン単独よりも症状をより効果的に制御できる可能性があるという証拠がいくつかあることに注目しています。どちらのアプローチも綿密なモニタリングが必要です。自宅で管理するのは安全ではありません。';

  @override
  String get ghbReferenceDay7 =>
      'GHB 1週間オフ\n\n出典：\"Characterization of the GHB Withdrawal Syndrome,\" on PubMed Central\n\nほとんどの症状が消えつつある\nいくつかのコア離脱症状は、最初の4日間で重症度または有病率で70 ％以上低下した。監督下のテーパリングでは、テーパリングフェーズ自体は平均11日間続き、その後約6日間の回復フェーズが続きました。そのため、プロセスが完全に完了していなくても、1週間で多くの人々がその改善に十分に取り組んでいます。\n\n残るものは何か\n• 発汗、震え、不安定な手\n• よく眠る、または逆に不眠症と落ち着きのなさ\n• 欲求\n\nこの研究では、これらの特定の症状は11日間でさえ比較的ほとんど変化しないことがわかったので、今週の持続性は珍しいことではありません。症候群が明確に解決するまで、継続的な医学的監視は依然として重要です。';

  @override
  String get ghbReferenceDay14 =>
      'GHB 2週間オフ\n\n出典：\"Characterization of the GHB Withdrawal Syndrome,\" on PubMed Central\n\n急性症候群の過去\n2週間までに、この研究で説明されている急性物理的症候群（そのテーパリングと回復のフェーズを合わせると、監督下で平均約17日間）は、一般的に解決されているか、非常に近づいています。心拍数、血圧、およびほとんどの身体症状は安定しているはずです。\n\n残るもの\nこの研究では、一部の患者の退院時に渇望と不眠症が依然として存在することを明確に示しており、これらが再発リスクに寄与する可能性があることに留意しています。危険な初期段階が過ぎ去った今でも、サポートと構造は重要です。';

  @override
  String get ghbReferenceDay30 =>
      'GHB 1か月オフ\n\n出典：\"Characterization of the GHB Withdrawal Syndrome,\" on PubMed Central\n\n1か月が経過する場所\nこの研究で説明されている急性で危険な段階は、1か月ほど経過しています。1か月までに、急性の危険な段階—最初の日に集中し、その後平均約2週間半の監督下のテーパと回復期間が続く—はるかに過ぎています。渇望と不眠症は、退院時に特定された主要な残存再発リスクです。\n\nサポートが引き続き役立つ理由\n渇望、気分の落ち込み、または睡眠障害が1か月でまだ存在する場合、それは研究の著者が再発リスク要因としてフラグ付けしたものと一致します。これが、継続的なサポートと構造が重要である理由です。';

  @override
  String get ghbReferenceDay90 =>
      'GHBが3か月オフ\n\n出典：\"Characterization of the GHB Withdrawal Syndrome,\" on PubMed Central\n\n3か月の回復期間\n3ヵ月までに、急性GHB離脱症候群は長期間にわたって解消される。退院時に特定された残存リスクは、渇望と不眠症であるため、3ヶ月の禁欲は、睡眠、自律神経の安定性、および再発予防ルーチンを強化するのにかなりの時間を与えます。\n\n一般的に報告される内容\n• いつもより落ち着いた気分\n• より信頼性の高い睡眠\n• より明確な思考とより少ない渇望\n\n不安、不眠症、または気分の低下が3ヵ月後も顕著である場合は、単独で解決すると仮定するよりも、臨床医と話し合う価値があります。';

  @override
  String get ghbReferenceDay180 =>
      'GHBが6か月オフ\n\n出典：\"Characterization of the GHB Withdrawal Syndrome,\" on PubMed Central\n\n半年後\n6ヵ月までに、急性GHB離脱症候群は長い間解消され、回復は解毒から安定した睡眠、渇望制御、および再発予防に完全に移行しました。危険な自律神経期とせん妄多発期は、この段階ではなく、最初の数日と数週間に属します。\n\nより広い視野で\nGHBの離脱を安全に乗り切り、半年間滞在することは、初期段階がどれほど危険であるか、そして部分的に長引く渇望と不眠症によって引き起こされる再発リスクがどれほど現実的であるかを考えると、大きな成果です。あなたをここに導いたルーチンとサポートは、維持する価値があります。';

  @override
  String get inhalantsReferenceDay1 =>
      '吸入剤をやめる：1日目\n\n出典：Radparvar, \"The Clinical Assessment and Treatment of Inhalant Abuse,\" The Permanente Journal (2023), on PubMed Central\n\n離脱が起こる理由\n慢性的な吸入剤使用は神経適応を引き起こします—神経系がその物質の存在を前提とするようになるのです。多くの吸入剤はアルコールと同じ脳回路に作用するため、やめると脳は一時的に不均衡になります。化学物質は血液から速やかに排出されますが体脂肪に蓄積されるため、離脱のタイミングは予測しにくくなることがあります。\n\n初期症状\nこのレビューは、吸入剤の離脱をアルコールまたはベンゾジアゼピンの離脱に類似するものと説明しており、報告される症状には以下が含まれます：\n• 吐き気、嘔吐、発汗\n• 震えと速い心拍数\n• 不眠と睡眠障害\n• 不安とイライラ\n\n安全性に関する注意\nより重度の症例では、レビューは報告される症状として幻覚、妄想、けいれんも挙げていますが、正確な日ごとのスケジュールは示していません—これらは固定されたタイムラインではなく起こり得る症状として扱ってください。解毒の間、特に大量・長期使用者では医療監督が賢明です。';
  ...
  String get marijuanaReferenceDay30 =>
      '大麻を断って1ヶ月：記憶機能の改善\n\n出典：Pope et al. (2001)、Archives of General Psychiatry\n\n大麻と記憶：問題\nこの研究は、大量・長期の大麻使用者を28日間の確認された断薬にわたって追跡し、思考と記憶のテスト結果を軽度使用者および非使用者と比較しました。断薬の開始時、そして1日目と7日目に、大量使用者は単語リストの再生で対照群より悪い成績を示しました—この欠損は尿中THC代謝物レベルと一致しており、生涯使用ではなく最近の薬物曝露を反映していました。\n\n良い知らせ：28日目までの回復\n28日目までに、大量使用者、軽度使用者、非使用者は、研究の思考と記憶のテストでほぼ同じ成績を示しました。また、その時点で生涯の総大麻使用量とテスト成績の間に有意な関係はありませんでした。\n\n30日時点での意味\n• 言語学習と再生が対照群の水準に戻った\n• 最初の1週間に見られた残存欠損は解消した\n• 初期の残存欠損は永続的な損傷ではなく、最近の曝露と結びついていた\n\nエビデンスが示すこと\n28日目までに、大量使用者は研究の全思考・記憶テストで軽度使用者および非使用者とほぼ区別がつかなくなりました。最初の1週間に見られた言語学習と再生の欠損は、対照群の水準まで回復していました。';
  ...
  String get mdmaReferenceDay1 =>
      'MDMA後：カメダウン\n\n出典：Meyer (2013), \"3,4-Methylenedioxymethamphetamine (MDMA): Current Perspectives,\" Substance Abuse and Rehabilitation\n\n気分が落ち込む理由\nMDMAは、セロトニンの大量放出（ドーパミンを含む）を促進することで機能します。その後、脳は一時的にセロトニンを枯渇させます。このレビューでは、使用から2〜5日後に初心者と経験豊富なユーザーの両方で測定された、いわゆる「ミッドウィークブルース」と呼ばれる気分の低下について説明します。\n\n役立つこと\n• 水分補給と栄養価の高い食べ物\n• 睡眠\n• 忍耐—ディップは枯渇であり、恒久的な状態ではありません\n\n1回の使用後のコメダウンは、依存関連の離脱とは異なり、同じレビューは渇望を伴うが有意な身体的症状はないと説明している。';

  @override
  String get mdmaReferenceDay3 =>
      'MDMAの数日後\n\n出典：Meyer (2013), \"3,4-Methylenedioxymethamphetamine (MDMA): Current Perspectives,\" Substance Abuse and Rehabilitation\n\nミッドウィーク・ブルース\nこれは、このレビューが「ミッドウィークブルース」について説明するときに大まかに説明しているウィンドウです。「ミッドウィークブルース」とは、初心者と経験豊富なユーザーの両方で使用後2〜5日で測定された気分の低下であり、長期的な変化ではなく短期的なセロトニン枯渇に関連しています。\n\n改善点\n• 気分は通常、現在の最低点から上昇します\n• エネルギー復帰\n• 睡眠が正常化し始める';

  @override
  String get mdmaReferenceDay7 =>
      'MDMAの1週間後\n\n出典：Meyer (2013), \"3,4-Methylenedioxymethamphetamine (MDMA): Current Perspectives,\" Substance Abuse and Rehabilitation\n\nミッドウィーク・ブルースを過ぎて\nほとんどの人にとって、1週間はこのレビューが急性コメダウンと関連付けられている2〜5日の期間を過ぎているため、気分は正常に戻るはずです。このレビューでは、大量または繰り返し使用する人にとって、依存パターンの一部として渇望が持続する可能性があると指摘していますが、これは重大な身体的離脱症状を伴うとは説明されていません。\n\nヘルプを求めるタイミング\n気分の落ち込み、不安、または睡眠の問題が1週間続く場合、それはコメダウン以上のものかもしれません。専門家に相談する価値があります。';

  @override
  String get mdmaReferenceDay14 =>
      'MDMAの2週間オフ\n\n出典：Meyer (2013), \"3,4-Methylenedioxymethamphetamine (MDMA): Current Perspectives,\" Substance Abuse and Rehabilitation\n\nリカバリタイムライン\n使い捨てのコメダウンでは、このレビュー文書の2〜5日間の浸漬から2週間が経過しているため、気分、睡眠、集中力は安定している必要があります。より重度または繰り返し使用した後、回復はコメダウンを超えて継続し、禁欲的なイメージング研究は、持続的な禁欲とともにセロトニン再循環能力が上昇することを示す。\n\nこれがあなたにとって意味することは\n時折使用した場合は、最悪の事態を乗り越えている可能性があります。頻繁にまたは重い場合は、自分自身に忍耐強くしてください。セロトニンシグナルの完全な回復は、2週間よりも長いプロセスであり、次のマイルストーンで説明します。';

  @override
  String get mdmaReferenceDay30 =>
      'MDMAを1か月オフ\n\n出典：\"Serotonin transporter availability, neurocognitive function and their correlation in abstinent MDMA users,\" on PubMed\n\n1か月が経過する場所\n急性のコメダウンと離脱はあなたの背後にあり、気分と思考と記憶はより安定しています。イメージング研究は、MDMAがセロトニンを処理する脳の能力を低下させ、この能力が持続的な禁欲で回復することを示しています。\n\nリカバリシグナル\n同じ研究では、セロトニンのリサイクル能力が持続的な禁欲で回復していることが示されています。気分とセロトニン機能は最初に改善されますが、記憶は独自の回復タイムラインで継続されます。継続的な禁欲は両方をサポートします。';

  @override
  String get mdmaReferenceDay90 =>
      'MDMAが3か月オフ\n\n出典：\"Serotonin transporter availability, neurocognitive function and their correlation in abstinent MDMA users,\" on PubMed\n\n継続的な回復\n持続的な禁欲により、脳のセロトニン系は、特に脳の深部で回復し続けています。この時点では、気分と睡眠は通常安定しています。\n\nリカバリシグナル\n持続的な禁欲は、脳領域にわたってセロトニントランスポーターの回復を促進し続け、気分と睡眠は安定したままであり、思考と記憶の回復は継続しています。';

  @override
  String get mdmaReferenceDay365 =>
      'MDMA 1年オフ\n\n出典：\"Serotonin transporter availability, neurocognitive function and their correlation in abstinent MDMA users,\" on PubMed\n\n1年後\n1年間の禁欲により、脳のセロトニン処理は大幅に回復し、気分は安定しています。\n\nリカバリシグナル\n1年間の禁欲は、セロトニン系に長期の回復期間を与えます。イメージング研究は、セロトニンリサイクル能力が禁欲とともに上昇し、この段階で実質的なセロトニン回復が最も明確な生物学的シグナルとなることを示している。';

  @override
  String get methReferenceDay1 =>
      'メタンフェタミン離脱：最初の24時間\n\n出典：McGregor et al., \"The nature, time course and severity of methamphetamine withdrawal,\" Addiction (2005), on PubMed\n\nクラッシュ\nメタンフェタミンは大量のドーパミン放出を駆動します。使用をやめると、その系は枯渇したまま残されます。この研究は断薬の最初の3週間にわたって離脱症状を毎日追跡し、全体的な重症度が最終使用から24時間以内に最も高くなることを発見しました—極端な刺激から身体的・心理的疲弊への急激な転換である「クラッシュ」です。\n\n1日目の症状\nこの研究は、今最も激しい離脱の特徴を記録しました：\n• 極度の疲労と睡眠の増加（過眠症）\n• 食欲の増加（メスは食欲を強力に抑制する）\n• 抑うつ気分と快感の喪失\n• 強い渇望\n• 不安とイライラ\n\n身体的な安全性\nメタンフェタミン離脱症候群自体は一般に生命を脅かすものではありませんが、この研究で測定された抑うつ関連症状は初期に重度になることがあり、自殺念慮を含み得ます。特に大量使用者では医療監督が強く推奨されます。\n\n持ち上がり始める\nこの研究からの励みとなる発見：重症度は最初が最も高く、その後下降します。この24時間のピークから、症状はその後の数日間で着実に低下します—最悪の地点は始まりなのです。';
